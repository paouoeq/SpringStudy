...
public class UserMain2 {
	...
	public static void main(String[] args) {
		...
		// 빈 얻기
		UserService2 xxx = ctx.getBean("xxx", UserService2.class);
		System.out.println(xxx.getNum()+xxx.getUsername()); // 0null
		
		UserService2 yyy = ctx.getBean("yyy", UserService2.class);
		System.out.println(yyy.getNum()+yyy.getUsername()); // 10홍길동
	}
