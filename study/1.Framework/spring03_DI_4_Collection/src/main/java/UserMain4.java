...
public class UserMain4 {
	...
	public static void main(String[] args) {
		// IoC Container 생성
		ApplicationContext ctx = new ClassPathXmlApplicationContext("classpath:com/config/user4.xml"); // GenericXmlApplicationContext와 동일
		...
		for(String key : keys) {
			System.out.println(key + "\t" + phones.getProperty(key)); // map의 get()과 동일
		}
	}
